...
def randomize_model(xml_string):
    ...
    if body is not None:
        ...
        random.shuffle(leg_names)  # Shuffle to attach legs to random vertices

        # Attach each leg to a random vertex
    ...
    # Remove or update actuators based on removed joints
